...
public class PkfieldsExample {
    ...
    protected abstract static class GeneratedCriteria {
        protected List<Criterion> stringbooleanCriteria;
        ...
        protected GeneratedCriteria() {
            ...
            stringbooleanCriteria = new ArrayList<>();
        }

        public List<Criterion> getStringbooleanCriteria() {
            return stringbooleanCriteria;
        }

        protected void addStringbooleanCriterion(String condition, Object value, String property) {
            if (value == null) {
                throw new RuntimeException("Value for " + property + " cannot be null");
            }
            stringbooleanCriteria.add(new Criterion(condition, value, "mbg.test.mb3.common.StringBooleanTypeHandler"));
            allCriteria = null;
        }

        protected void addStringbooleanCriterion(String condition, boolean value1, boolean value2, String property) {
            stringbooleanCriteria.add(new Criterion(condition, value1, value2, "mbg.test.mb3.common.StringBooleanTypeHandler"));
            allCriteria = null;
        }

        public boolean isValid() {
            return criteria.size() > 0
                || stringbooleanCriteria.size() > 0;
        }
        ...
        public List<Criterion> getAllCriteria() {
            if (allCriteria == null) {
                ...
                allCriteria.addAll(stringbooleanCriteria);
            }
            return allCriteria;
        }
