...
public interface FieldsonlyMapper {
    ...
    @ConstructorArgs({
        @Arg(column="INTEGERFIELD", javaType=Integer.class, jdbcType=JdbcType.INTEGER),
        @Arg(column="DOUBLEFIELD", javaType=Double.class, jdbcType=JdbcType.DOUBLE),
        @Arg(column="FLOATFIELD", javaType=Double.class, jdbcType=JdbcType.DOUBLE)
    })
