...
public class PkfieldsblobsSqlProvider {
    ...
    public String countByExample(PkfieldsblobsExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("PKFIELDSBLOBS A");
    ...
    public String deleteByExample(PkfieldsblobsExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("PKFIELDSBLOBS A");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String selectByExampleWithBLOBs(PkfieldsblobsExample example) {
        ...
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("A.ID1 as A_ID1");
        } else {
        ...
        sql.SELECT("A.BLOB1 as A_BLOB1");
        sql.FROM("PKFIELDSBLOBS A");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getFirstname() != null) {
            sql.SET("A.FIRSTNAME = @{record.firstname,jdbcType=VARCHAR}");
        }
        ...
        if (record.getBlob1() != null) {
            sql.SET("A.BLOB1 = @{record.blob1,jdbcType=VARBINARY}");
        }
