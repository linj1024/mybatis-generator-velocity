 ...
 * @author Jeff Butler
 */
public class AnnotatedSelectByEntityMethodGenerator extends SelectByEntityMethodGenerator {
    
    public AnnotatedSelectByEntityMethodGenerator() {
        super();
    }
    ...
    public void addMapperAnnotations(Interface interfaze, Method method) {
        ...
        List<StringBuilder> listSbWhere = new ArrayList<StringBuilder>();
        
        while (iter.hasNext()) {
            IntrospectedColumn column = iter.next();
            sb.append(escapeStringForJava(getSelectListPhrase(column)));
            hasColumns = true;
            ...
            javaIndent(sbWhere, 1);
            sbWhere.append("\"      #if($_parameter.");
            sbWhere.append(column.getJavaProperty(null));
            sbWhere.append(") and ");
            sbWhere.append(escapeStringForJava(getEscapedColumnName(column)));
            sbWhere.append(" = ");
            sbWhere.append(getParameterClause(column));
            sbWhere.append(" #end\",");
            listSbWhere.add(sbWhere);
        }
        ...
        for(StringBuilder sbw : listSbWhere) {
            method.addAnnotation(sbw.toString());
        }
